...
- [ ] [Complete the official Next.js Learn course (App Router, Server Components, data fetching)](https://nextjs.org/learn) (STACK-01)
- [ ] [Read the TypeScript Handbook: Everyday Types and Narrowing sections, and apply to the portfolio's `src/lib/`](https://www.typescriptlang.org/docs/handbook/2/everyday-types.html) (STACK-02)
...
- [ ] Author a technical writeup explaining every file in `src/` and `scripts/` of this repository in the applicant's own words (STACK-10)
