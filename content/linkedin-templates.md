...
Each template is under 300 characters (LinkedIn's note limit) and must be personalised per send. Placeholders in `{curly_braces}` are replaced per contact; templates are never sent verbatim.

---

## 1. Existing warm contact (NET-01, Phase 1)
